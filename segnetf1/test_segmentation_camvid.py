...
caffe_root = '~/work/yixi/software/caffe-segnet/' 			# Change this to the absolute directoy to SegNet Caffe
import sys
...
for line in open(input_source,'r'):
	...
	IMAGE_FILE = os.path.join(outputs, os.path.basename(im_file).split('.')[0])
	...
	scipy.misc.imsave(IMAGE_FILE+'.png', ind)
	label_flat = label
